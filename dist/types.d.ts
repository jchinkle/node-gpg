...
export declare type SpawnGpgFn = (input: string, args: string[], gpgOptions?: Partial<IGpgOptions>) => Promise<void | Buffer>;
export declare type StreamingFn = (options: IStreamingOptions, args: string[], gpgOptions?: Partial<IGpgOptions>) => Promise<fs.WriteStream>;
